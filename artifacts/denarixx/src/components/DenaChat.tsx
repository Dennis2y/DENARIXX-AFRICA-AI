              ...
              {messages.map((msg, i) => (
                ...
                >
                  <div
                    ...
                    dangerouslySetInnerHTML={{ __html: renderMarkdown(msg.content) || (streaming && i === messages.length - 1 ? '<span class="inline-block w-2 h-4 bg-current animate-pulse rounded-sm" />' : "") }}
                  />
                </motion.div>
              ))}
